...
import SemanticEngineer from './SemanticEngineer';
import { ArrowLeft } from 'lucide-react';

function App() {
  const [currentPage, setCurrentPage] = useState<'landing' | 'process' | 'semantic'>('landing');
